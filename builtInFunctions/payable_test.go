...
func TestMustVerifyPayable(t *testing.T) {
	...
	t.Run("call type is MECTTransferAndExecute should return false", func(t *testing.T) {
		vmInput := &vmcommon.ContractCallInput{
			VMInput: vmcommon.VMInput{
				Arguments: [][]byte{[]byte("arg1"), []byte("arg2"), []byte("arg3")},
				CallType:  vm.MECTTransferAndExecute,
			},
		}
	...
	t.Run("caller is MECT address should return false", func(t *testing.T) {
		vmInput := &vmcommon.ContractCallInput{
			VMInput: vmcommon.VMInput{
				Arguments:  [][]byte{[]byte("arg1"), []byte("arg2"), []byte("arg3")},
				CallType:   vm.DirectCall,
